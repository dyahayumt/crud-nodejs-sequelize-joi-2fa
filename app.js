...
app.post('/updated-student', function(req, res) {
  ...
  var studentOldId = req.body.oldId;
	console.log(student_id+' '+first_name+' '+middle_name+' '+last_name+' '+place_of_birth+' '+date_of_birth+' '+phone_number+' '+email_address +' '+studentOldId);

	var postData  = {student_id: student_id, first_name: first_name, middle_name: middle_name, last_name: last_name, date_of_birth: date_of_birth, phone_number: phone_number, email_address: email_address};

  
	if(studentOldId !== undefined && studentOldId !== '') {
		con.query('UPDATE student SET student_id = ?, first_name = ?, middle_name = ?, last_name = ?, place_of_birth = ?, date_of_birth = ?, phone_number = ?, email_address = ? WHERE student_id = ?', [student_id, first_name, middle_name, last_name, place_of_birth, date_of_birth, phone_number, email_address, studentOldId], function (error, results, fields) {
			if (error) throw error;
			res.redirect('/students');
		});
	} else {
